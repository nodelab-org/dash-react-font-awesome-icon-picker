...
iconPicker <- function(id=NULL, value=NULL, hideSearch=NULL, containerStyles=NULL, buttonStyles=NULL, buttonIconStyles=NULL, pickerIconStyles=NULL, searchInputStyles=NULL, className=NULL) {
