...
class DashReactFontAwesomeIconPicker(Component):
    """A DashReactFontAwesomeIconPicker component.
...
- value (string; optional):
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'DashReactFontAwesomeIconPicker'
        ...
        super(DashReactFontAwesomeIconPicker, self).__init__(**args)
